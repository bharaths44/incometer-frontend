	...
	const [messages, setMessages] = useState([
		{
			role: 'assistant',
			content:
				"Hi! I'm your AI financial assistant. Ask me anything about budgeting, savings, or your expenses!",
		},
	]);
		...
		setTimeout(() => {
			setMessages((prev) => [
				...prev,
				{
					role: 'assistant',
					content:
						"That's a great question! Based on your current financial data, here are some personalized insights...",
				},
			]);
		}, 1000);
	};
