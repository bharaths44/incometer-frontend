...
import { PaymentMethodResponseDTO, PaymentMethodRequestDTO, PAYMENT_METHOD_TYPE_LABELS } from "@/types/paymentMethod";
...
export default function UpdatePaymentMethodModal({
    ...
    const handleUpdatePaymentMethod = async () => {
        if (!name.trim() || !type || !paymentMethod) {
            setErrorMessage('Please enter a payment method name and select a type');
            return;
        }
        ...
        if (existingPaymentMethod) {
            setErrorMessage('Another payment method with this name already exists!');
            return;
        }
        ...
        try {
            ...
            const updatedPaymentMethod = await updatePaymentMethod(paymentMethod.paymentMethodId, paymentMethodData);
