            ...
            <CardContent>
                <div className="space-y-4">
                    {budgetAnalytics.map((budget, index) => (
                        <div key={index} className="p-4 bg-muted rounded-2xl border">
                            ...
                            <div className="flex items-center justify-between mb-1">
                                <span className="text-sm text-muted-foreground">Spent: ₹{budget.spent}</span>
                                <span className="text-sm text-muted-foreground">Limit: ₹{budget.limit}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">Remaining: ₹{budget.remaining}</span>
