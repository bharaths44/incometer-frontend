...
export default function FinancialHealthScore({ userId }: FinancialHealthScoreProps) {
    ...
    const calculateHealthScore = (data: ExpenseSummary) => {
        ...
        const expenseRatio = data.totalIncome > 0 ? (data.totalExpense / data.totalIncome) * 100 : 100;
