                        ...
                        <div>
                            ...
                            <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                                <PopoverTrigger asChild>
                                    <Button
                                        variant="outline"
                                        className={`w-full justify-start text-left font-normal ${!formData.expenseDate && "text-muted-foreground"
                                            }`}
                                    >
                                        <CalendarIcon className="mr-2 h-4 w-4" />
                                        {formData.expenseDate ? format(new Date(formData.expenseDate), "PPP") : "Pick a date"}
                                    </Button>
                                </PopoverTrigger>
                                    ...
                                    <Calendar
                                        ...
                                        onSelect={(date) => {
                                            if (date) {
                                                ...
                                                setFormData({ ...formData, expenseDate: "" });
                                            }
