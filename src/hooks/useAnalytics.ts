...
export const analyticsKeys = {
    ...
    categoryBreakdown: (userId: number) => [...analyticsKeys.all, 'categoryBreakdown', userId] as const,
    expenseSummary: (userId: number) => [...analyticsKeys.all, 'expenseSummary', userId] as const,
    budgetAnalytics: (userId: number) => [...analyticsKeys.all, 'budgetAnalytics', userId] as const,
};
