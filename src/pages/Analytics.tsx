import {BarChart3, Calendar, DollarSign, PieChart, TrendingDown, TrendingUp,} from "lucide-react";
            ...
            <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="card">
                    ...
                    <div className="space-y-4">
                        <div
                            className="p-5 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                ...
                <span className="text-gray-700 font-medium">
                  Expense Reduction
                        ...
                        <div
                            className="p-5 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl border border-orange-100">
                            <div className="flex items-center justify-between mb-2">
                <span className="text-gray-700 font-medium">
                  Monthly Savings
                </span>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex-1">
                        ...
                        <p className="text-green-50">
                            Based on your current spending and income trends, you're on track
                            to exceed your savings goal by 22%.
                        </p>
                    </div>
