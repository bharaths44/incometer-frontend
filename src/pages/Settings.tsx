    ...
    return (
        <div className="page-transition space-y-8">
            <div>
                ...
                <p className="text-gray-600">Customize your Incometer experience</p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  Recommended
                    ...
                    <div className="card border-2 border-red-200 bg-red-50">
                        ...
                        <button
                            className="w-full p-4 rounded-2xl bg-red-600 hover:bg-red-700 transition-colors text-white font-semibold">
                            Delete Account
                        </button>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="flex gap-3">
                            <button
                                className="px-6 py-2 bg-white text-green-600 rounded-xl font-semibold hover:shadow-lg transition-all">
                                Help Center
                            </button>
                            <button
                                className="px-6 py-2 bg-white/20 backdrop-blur-sm text-white rounded-xl font-semibold hover:bg-white/30 transition-all">
                                Contact Support
                            </button>
                        </div>
                    </div>
