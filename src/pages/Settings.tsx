import { Moon, Sun, Globe, Bell, Lock, Trash2, Download, Shield } from 'lucide-react';
            ...
            <div className="space-y-3">
              <button className="w-full p-4 rounded-2xl bg-blue-50 hover:bg-blue-100 transition-colors text-left border-2 border-blue-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-700">Download all your data</div>
                  </div>
                </div>
              </button>
              ...
              <button className="w-full p-4 rounded-2xl bg-orange-50 hover:bg-orange-100 transition-colors text-left border-2 border-orange-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-orange-900">Backup Data</div>
                    <div className="text-sm text-orange-700">Create a backup</div>
                  </div>
                </div>
              </button>
            </div>
