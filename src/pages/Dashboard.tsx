import { TrendingUp, TrendingDown, Wallet, DollarSign, Calendar, ArrowUpRight, ArrowDownRight } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const recentTransactions = [
    { id: 1, name: 'Grocery Shopping', category: 'Food', amount: -125.50, date: 'Today', icon: '🛒' },
    { id: 2, name: 'Freelance Project', category: 'Income', amount: 2500.00, date: 'Yesterday', icon: '💼' },
    { id: 3, name: 'Netflix Subscription', category: 'Entertainment', amount: -15.99, date: '2 days ago', icon: '🎬' },
    { id: 4, name: 'Coffee Shop', category: 'Food', amount: -8.50, date: '3 days ago', icon: '☕' },
    { id: 5, name: 'Salary Deposit', category: 'Income', amount: 5000.00, date: '5 days ago', icon: '💰' }
  ];

  const categoryBreakdown = [
    { category: 'Food & Dining', amount: 850, percentage: 32, color: 'bg-orange-500' },
    { category: 'Transportation', amount: 420, percentage: 16, color: 'bg-blue-500' },
    { category: 'Entertainment', amount: 280, percentage: 11, color: 'bg-green-500' },
    { category: 'Shopping', amount: 650, percentage: 24, color: 'bg-pink-500' },
    { category: 'Bills & Utilities', amount: 450, percentage: 17, color: 'bg-yellow-500' }
  ];
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <div className={`flex items-center gap-1 text-sm font-medium ${stat.trend === 'up' ? 'text-green-600' : 'text-orange-600'}`}>
          ...
          <div className="space-y-4">
            {recentTransactions.map((transaction) => (
              ...
              >
                ...
                <div className={`text-lg font-bold ${transaction.amount > 0 ? 'text-green-600' : 'text-gray-900'}`}>
          ...
          <div className="space-y-5">
            {categoryBreakdown.map((item, index) => (
              <div key={index}>
                ...
                <div className="text-xs text-gray-500 mt-1">{item.percentage}% of spending</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="card bg-gradient-to-br from-green-500 to-emerald-600 border-0 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-green-50">Excellent! Keep up the great work.</div>
          </div>
