import { TrendingUp, Wallet, BarChart3, Sparkles, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Effortlessly track every dollar with intuitive categorization and insights.'
    },
    {
      icon: TrendingUp,
      title: 'Income Management',
      description: 'Monitor all income streams and understand your financial growth.'
    },
    {
      icon: BarChart3,
      title: 'Visual Analytics',
      description: 'Beautiful charts and reports that make sense of your finances.'
    },
    {
      icon: Sparkles,
      title: 'AI Financial Assistant',
      description: 'Get instant answers to your budgeting questions with AI-powered chat.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Experience a fresh approach to personal finance. Beautifully designed,
            incredibly simple, powered by intelligence.
          </p>
          <button
            onClick={onGetStarted}
